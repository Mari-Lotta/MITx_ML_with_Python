...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        ### Backpropagation ###
        # Compute gradients
        output_layer_error = (y - activated_output) * output_layer_activation_derivative(activated_output)  # Scalar
        ...
        ) * output_layer_error  # 3 by 1 matrix

        bias_gradients = hidden_layer_error  # 3 by 1 matrix
        hidden_to_output_weight_gradients = hidden_layer_activation * output_layer_error  # 3 by 1 matrix
        input_to_hidden_weight_gradients = input_values * hidden_layer_error.T  # 2 by 3 matrix

        # Use gradients to adjust weights and biases using gradient descent
        self.biases += self.learning_rate * bias_gradients
        self.input_to_hidden_weights += self.learning_rate * input_to_hidden_weight_gradients.T
